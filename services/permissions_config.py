...
PERMISSION_TREE = {
    ...
    PERMISSION_TASK_REPORT: [
        ...
        ('task_report_vehicle_period_detail', 'Vehicle Period Detail – List / View'),
    ...
    PERMISSION_REPORTS: [
        ...
        ('driver_attendance_report', 'Monthly Attendance Report'),
        ('driver_attendance_daily_report', 'Day Wise Attendance Report'),
    ...
    PERMISSION_TRACKING: [
        ...
        ('tracking_reports', 'Trips, Fleet, Mileage & Activity Reports'),
...
PERMISSION_DEPENDENCIES = {
    ...
    'driver_update_text': ['report_driver_profile'],
    ...
    'workspace_slip_design_manage': ['workspace_transfer_add'],
    ...
    'task_report_list': [],
    'task_report_vehicle_period_detail': ['task_report_list'],
...
SECTION_PAGE_GROUPS = {
    ...
    PERMISSION_TASK_REPORT: [
        ...
        ('Daily Task Report', [
            ...
            ('task_report_vehicle_period_detail', 'Vehicle Period Detail'),
    ...
    PERMISSION_REPORTS: [
        ...
        ('Monthly Attendance Report', [('driver_attendance_report', 'Monthly Attendance Report')]),
        ('Day Wise Attendance Report', [('driver_attendance_daily_report', 'Day Wise Attendance Report')]),
    ...
    PERMISSION_TRACKING: [
        ...
        ('Reports', [('tracking_reports', 'Fleet, Mileage & Activity Reports')]),
...
PAGE_VISIBLE = {
    ...
    'task_report_vehicle_period_detail': ['task_report', 'task_report_vehicle_period_detail'],
    ...
    'workspace_mpg_report': ['workspace_mpg_report', 'reports'],
    # Reports
    ...
    'driver_attendance_daily_report': ['reports', 'driver_attendance_report'],
    ...
    'driver_salary_slip': ['reports', 'driver_salary_slip'],
    ...
    'receipt_vouchers_list': ['accounts', 'accounts_quick_receipt'],
    'bank_entries_list': ['accounts', 'accounts_bank_entry'],
    ...
    'driver_rejoin_list': ['driver_status', 'driver_rejoin', 'driver_rejoin_list'],
    'chart_of_accounts_list': ['accounts', 'chart_of_accounts'],
    # Administration
