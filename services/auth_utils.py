...
ENDPOINT_PERMISSION_MAP = [
    ...
    ('driver_doc_update_delete', 'drivers'),
    ...
    ('oil_work_order_list', 'oil_expense'),
    ('oil_work_order_export', 'oil_expense'),
    ...
    ('employee_expense_media', 'employee_expense'),
    ('employee_expense_media_download', 'employee_expense'),
    ('employee_expense_media_download_all', 'employee_expense'),
    # Employee Workspace
    ...
    ('party_import_template', 'workspace_party_add'),
    ('party_import', 'workspace_party_add'),
    ('party_export', 'workspace_party_list'),
    ('party_print', 'workspace_party_list'),
    ('party_delete', 'workspace_party_list'),
    ('party_form', 'workspace_party_add'),
    ('party_list', 'workspace_party_list'),
    ...
    ('report_driver_roster', 'report_driver_roster'),
    ('report_driver_roster_export', 'report_driver_roster'),
    ('report_driver_profile', 'report_driver_profile'),
    ('report_driver_profile_public', None),
    ('report_expiry', 'report_expiry'),
    ('report_ai', 'report_ai'),
    ('ai_assistant', 'report_ai'),
    ('ai.ai_assistant', 'report_ai'),
    ('ai_query', 'report_ai'),
    ('ai.ai_query', 'report_ai'),
    ('ai_recent', 'report_ai'),
    ('ai.ai_recent', 'report_ai'),
    ('ai_conversations', 'report_ai'),
    ('ai.ai_conversations', 'report_ai'),
    ('ai_conversation_new', 'report_ai'),
    ('ai.ai_conversation_new', 'report_ai'),
    ('ai_conversation_detail', 'report_ai'),
    ...
    ('tracking_ignition_report', 'tracking_reports'),
    ...
    ('api_personal_daily_summary', 'personal_view'),
    ('api_personal_fleet_kpis',    'personal_view'),
    ('api_personal_vehicle_fuel',  'personal_view'),
    ('api_personal_vehicle_maintenance', 'personal_view'),
    ('api_personal_maintenance_fleet', 'personal_view'),
    ('personal_maintenance',      'personal_view'),
