...
FREEZE_FORM_CATALOG = [
    ...
    ('Finance - DTO Transaction Add', 'dto_txn_new'),
    ('Finance - DTO Transaction Edit', 'dto_txn_edit'),
    ('Finance - DTO Transaction Verify', 'dto_txn_verify'),
    ('Finance - DTO Transaction Cancel', 'dto_txn_delete'),
    ('Finance - DTO Counterparty Master', 'dto_counterparty_list'),
    ('Finance - DTO Settlement Create', 'dto_settlement_new'),
    ('Finance - DTO Settlement Post', 'dto_settlement_post'),
    ('Finance - DTO Settlement Cancel', 'dto_settlement_cancel'),
