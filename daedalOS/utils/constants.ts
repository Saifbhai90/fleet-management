...
/** Browser tab icon when no window overrides it — replace `public/fleet-brand/favicon.svg` with your FleetManager logo. */
export const FAVICON_BASE_PATH = "/fleet-brand/favicon.svg";
...
export const PACKAGE_DATA = {
  ...
  description: "FleetManager Personal Tools desktop",
  license: "MIT",
  version: "2.0.0",
};
