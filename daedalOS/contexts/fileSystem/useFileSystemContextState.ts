...
const useFileSystemContextState = (): FileSystemContextState => {
  ...
  const mountHttpRequestFs = useCallback(
    async (
      ...
      const HTTPRequestBackend =
        (FileSystem as unknown as Record<string, typeof FileSystem.XmlHttpRequest>)
          .HTTPRequest ?? FileSystem.XmlHttpRequest;

      return new Promise((resolve, reject) => {
        HTTPRequestBackend?.Create(
